...
- (void)setup{
    ...
    [self setTitleColor:[UIColor colorWithWhite:0.125 alpha:1.000] forState:UIControlStateNormal];
    self.titleLabel.font = [UIFont systemFontOfSize:14.5f];
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect
{
    ...
    return CGRectMake(0, H*3/5 -8, W, H*2/5);
}
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect
{
    ...
    return CGRectMake(0, 10, W, H*3/5 -10);
}
