...
@implementation Fetch2TableViewCell

#pragma mark - 初始化
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"Fetch2TableViewCell";
    Fetch2TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[Fetch2TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
...
- (void) setBaseView{
    ...
    self.nameLabel.font = [UIFont systemFontOfSize:16.5];
