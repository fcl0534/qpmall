...
#define APP_ID          @"wxca96ac758ed84b38"               //APPID
#define APP_SECRET      @"db97c7e363165a1354a67c2a2b970800" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1269122201"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"zhangzhongbaowangluokejizzbmall6"
//支付结果回调页面
#define NOTIFY_URL      @"http://zzbmall.cn/mobile/api/payment/wxpay/notify_url.php"
//获取服务器端支付数据地址（商户自定义）
...
//签名实例测试
- ( NSMutableDictionary *)sendOrder_name:(NSString *)name order_price:(NSString *)price orderno:(NSString *)orderSn;
